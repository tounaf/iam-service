...
class MembreCarteControllerTest extends TestCase
{
    ...
    public function testInvokeReturnsJsonResponseForFicheRoute(): void
    {
        $fiangonana = new Fiangonana();
        ...
        $member->method('getPrenom')->willReturn('Haja');
        $member->method('getEmail')->willReturn('haja@example.com');
        $member->method('getTelephone')->willReturn('+261320000111');
        ...
        $this->assertEquals('Haja', $data['prenom']);
