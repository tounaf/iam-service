 ...
 */
final class Version20260806124737 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial migration for Parish organization with MySQL dialect, featuring unique member qr_code_token and presence tracking.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        // Table: presence
        $this->addSql('CREATE TABLE presence (id INT AUTO_INCREMENT NOT NULL, membre_id INT NOT NULL, scanned_by_id INT DEFAULT NULL, activity_name VARCHAR(255) NOT NULL, scanned_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6977C7A56A99F74A (membre_id), INDEX IDX_6977C7A5EBBC642F (scanned_by_id), PRIMARY KEY(id), CONSTRAINT FK_6977C7A56A99F74A FOREIGN KEY (membre_id) REFERENCES membre (id) ON DELETE CASCADE, CONSTRAINT FK_6977C7A5EBBC642F FOREIGN KEY (scanned_by_id) REFERENCES membre (id) ON DELETE SET NULL) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE IF EXISTS presence');
